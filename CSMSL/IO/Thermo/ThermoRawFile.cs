...
namespace CSMSL.IO.Thermo
{
    public class ThermoRawFile : MSDataFile<ThermoSpectrum>
    {
        ...
        public ThermoSpectrum GetUnlabeledSpectrum (int spectrumNumber)
        {
            var unlabeledData = GetUnlabeledData(spectrumNumber, false);
            return new ThermoSpectrum(unlabeledData);
        }
        ...
        public Dictionary<string, string> GetStatusLog(int scanNum)
        {
            ...
            int pnArraySize = -1;
             ...
             {
                 if (!returnDict.ContainsKey(labelArray[i]))
                 {
                     returnDict.Add(labelArray[i], valueArray[i]);
                 }
             }
                 return returnDict;
        }
        ...
        public string GetFileName()
        {
            ...
            _rawConnection.GetFileName(ref refString);
            return refString;
        }
